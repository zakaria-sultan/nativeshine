          ...
          <div className="flex flex-col lg:flex-row gap-10 md:gap-16 lg:gap-20">
              ...
              <div className="sticky top-40 space-y-8">
                ...
                <div className="bg-[#0ea5e9] p-8 text-white rounded-sm shadow-xl shadow-cyan-500/10">
                  ...
                  <p className="text-sm font-medium text-white/80 leading-relaxed">
                    We deliver services that are not just compliant, but
            ...
            <div className="lg:w-2/3">
              ...
              <div className="mt-8 pt-8 border-t border-slate-100 flex flex-wrap gap-6 items-center">
                <Link
                  to="/contact"
                  className="bg-[#0ea5e9] text-white px-10 py-4 font-black text-sm uppercase tracking-widest hover:bg-slate-900 transition-all flex items-center gap-3"
                >
                  Request a Quote <ArrowRight size={18} />
                </Link>
                <Link
                  to="/services"
                  className="text-slate-400 hover:text-slate-900 font-black text-sm uppercase tracking-widest transition-colors"
                >
                  View All Services
                </Link>
              </div>
