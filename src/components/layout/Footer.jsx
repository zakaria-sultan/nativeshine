            ...
            <div className="container mx-auto px-6 py-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 items-start">
                    ...
                    <div className="flex flex-col">
                        <h4 className="text-slate-900 text-xs font-black uppercase tracking-[0.2em] mb-8">Site Map</h4>
                        <ul className="space-y-4">
                            {siteMap.map((link) => (
                                <li key={link.name}>
                                    <Link to={link.path} className="text-slate-400 hover:text-[#0ea5e9] text-sm font-bold transition-colors flex items-center gap-2 group">
                                        <ArrowRight size={12} className="opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all text-[#0ea5e9]" />
                                        {link.name}
                                    </Link>
                                </li>
                            ))}
                    ...
                    {/* Column 3: Services */}
                    <div className="flex flex-col">
                        <h4 className="text-slate-900 text-xs font-black uppercase tracking-[0.2em] mb-8">Services</h4>
                        <ul className="space-y-4">
                            {servicesData.map((service) => (
                                <li key={service.id}>
                                    <Link to={`/services/${service.slug}`} className="text-slate-400 hover:text-[#0ea5e9] text-sm font-bold transition-colors flex items-center gap-2 group">
                                        <ArrowRight size={12} className="opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all text-[#0ea5e9]" />
                                        {service.title}
                                    </Link>
                                </li>
                    ...
                    {/* Column 4: Follow Us */}
                    <div className="flex flex-col">
                        <h4 className="text-slate-900 text-xs font-black uppercase tracking-[0.2em] mb-8">Follow Us</h4>
                        ...
                        <div className="mt-8 p-6 bg-[#FAFAFA] rounded-sm border border-gray-100">
                            <p className="text-xs font-black text-slate-900 uppercase tracking-widest mb-2">Office Hours</p>
                            <p className="text-xs text-slate-500 font-bold">Mon - Fri: 08:00 - 18:00</p>
                        </div>
                    </div>
